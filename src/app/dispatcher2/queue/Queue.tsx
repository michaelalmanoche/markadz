    ...
    <div className="p-6">
      ...
      <div className="flex space-x-4">
        <section className="mb-8 rounded-lg p-4 w-1/2">
          ...
          <button className="mt-[-3rem] absolute ml-[18rem] bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600" onClick={handleQueueAll} disabled={selectedIdleAssignments.length === 0}>
            Schedule
          </button>
          ...
          {updatedAssignments
            ...
            .map((assignment: any, index: number) => (
              <tr key={assignment.id}>
                ...
                <td className="py-2 px-2 text-center border-b">{assignment.VanDriverOperator.Van.plate_number}</td>
                <td className="py-2 px-2 border-b ">{assignment.queued_at ? new Date(assignment.queued_at).toLocaleTimeString() : 'N/A'}</td>
                <td className="py-2 px-2 border-b">{assignment.estimatedDepartureTime}</td>
                <td className="py-2 px-2 border-b">{assignment.estimatedArrivalTime}</td>
