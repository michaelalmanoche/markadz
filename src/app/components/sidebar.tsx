      ...
      <div>
        ...
        <nav className="mt-4">
          ...
          <Link href="/admin/assignments"
            ...
            <Link href="/admin/viewing"
              className={`relative flex items-center space-x-2 p-2 rounded-md mt-2 group cursor-pointer ${activeLink === '/admin/viewing' ? 'bg-custom-white text-custom-black' : 'text-gray-400 hover:bg-custom-white hover:text-custom-black'}`}
              onClick={() => setActiveLink('/admin/viewing')}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="gray" className={`w-5 h-5 ${activeLink === '/admin/viewing' ? 'stroke-custom-black' : 'group-hover:stroke-custom-black'}`}>
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M12 6.5v5l3.5 2.1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
